          ...
          <article className="text-content">
            <div className="liquid-glass-container">
              ...
              >
                {(filterId) => (
                  <div
                    className="liquid-glass-filter-box"
                    style={{
                      width: 200,
                      height: 200,
                      borderRadius: 50,
            ...
            <p>
              깊은 산속 작은 마을에 한 나무꾼이 살고 있었습니다. 그는 매일 산에 올라가 나무를 하며 근근이 살아가고
              있었죠. 어느 화창한 봄날, 나무꾼은 평소와 다른 길로 산을 오르게 되었습니다.
            </p>
            ...
            <p>
              문득 정신을 차린 나무꾼은 해가 저물고 있음을 깨달았습니다. 서둘러 집으로 가려고 일어서는데, 옆에 두었던
              도끼 자루가 썩어 부스러져 있었습니다. 놀란 나무꾼이 급히 마을로 내려가 보니, 그가 알던 마을의 모습은
              온데간데없었습니다.
            </p>
            ...
            <p>
              이 이야기는 우리에게 시간의 상대성과 삶의 무상함을 일깨워줍니다. 신선의 세계와 인간의 세계가 다르듯,
              우리가 느끼는 시간의 흐름도 각자 다를 수 있습니다. 때로는 즐거운 순간은 너무 빨리 지나가고, 힘든 시간은
              더디게 흐르는 것처럼 느껴지죠.
            </p>
            ...
            <p>
              나무꾼의 이야기는 여기서 끝이 났지만, 그가 남은 생을 어떻게 살았는지는 아무도 모릅니다. 어쩌면 그는 다시
              그 신비로운 계곡을 찾아 헤맸을지도 모르고, 어쩌면 새로운 세상에 적응하며 살아갔을지도 모릅니다.
            </p>
